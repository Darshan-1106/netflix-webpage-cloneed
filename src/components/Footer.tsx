...
const Footer = () => {
  return (
    <footer className="mt-16 pb-8 text-netflix-gray">
      <div className="netflix-container">
        <div className="flex flex-col space-y-6">
          <div className="flex space-x-4">
            <a href="#" className="hover:text-netflix-white">
              <svg
          ...
          <div>
            <button className="border border-netflix-gray text-sm px-2 py-1 hover:text-netflix-white">
              Service Code
            </button>
          </div>
